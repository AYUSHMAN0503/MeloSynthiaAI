...
from services.music_gen.callModel import (
    predictMusic,
    initiate_request,
    check_for_music,
    SUCCESS,
...
def check_update():
    try:
        ...
        if result == SUCCESS:
            ...
            return {
                "message": "No music in folder, possibly music is'nt generating in model",
                "status": 400,
                "error": False,
            }, 400
            ...
            print("File error")
            return {
                "message": "Issue in generation / fetching music from gradio",
                "status": 500,
                "error": True,
            }, 500
