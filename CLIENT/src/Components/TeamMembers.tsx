const TeamMembers = [
    {
      ...
      position: 'Team Leader, Full-Stack Developer and DevOps',
...

    {
      ...
      bio: 'Meet Nikita, a blockchain developer drawn to cutting-edge tech, delving into smart contracts and decentralized apps. With a computer science background, she is dedicated to blockchain advancement, while also enjoying music and exploring new cultures through travel.',
      about: 'Nikita`s dual commitment to growth, both professionally and personally, shines in her technical skills and adventurous spirit. She embodies a promising blockchain enthusiast on an exciting research and development journey.',
...
{/*images used here are taken from public/images*/}
