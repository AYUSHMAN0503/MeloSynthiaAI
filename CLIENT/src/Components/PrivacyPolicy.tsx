...
const PrivacyPolicy = () => {
  return (
    <div className="bg-app-bg text-white p-6">
      ...
      <h3 className="text-md font-semibold mt-2">Types of Data Collected</h3>
      ...
      <h2 className="text-lg font-semibold mt-4 section-title">Usage Data</h2>
      <p>
      ...
      <h2 className="text-lg font-semibold mt-4 section-title">Information from Third-Party Social Media Services  </h2>
        ...
        <p>
          You may also have the option of sharing additional information with the Company through Your Third-Party Social Media Service's account. If You choose to provide such information and Personal Data, during registration or otherwise, You are giving the Company permission to use, share, and store it
          in a manner consistent with this Privacy Policy.
        </p>
      
      <h2 className="text-lg font-semibold mt-4 section-title">Tracking Technologies and Cookies</h2>
        ...
        <ul className="list-disc pl-6 mb-6">
          ...
          <li>
            Web Beacons. Certain sections of our Service and our emails may contain small electronic files known as web beacons (also referred to as clear gifs, pixel tags, and single-pixel gifs) that permit the Company, for example, to count users who have visited those pages or opened an email and for other related website statistics (for example, recording the popularity of a certain section and verifying system and server
            integrity).
          </li>
        </ul>
        ...
        <p>For more information about the cookies we use and your choices regarding cookies, please visit our Cookies Policy or the Cookies section of our PrivacyPolicy.</p>
      
      <h2 className="text-lg font-semibold mt-4 section-title">Use of Your Personal Data </h2>
      ...
      <h2 className="text-lg font-semibold mt-4 section-title">Retention of Your Personal Data </h2>
        <p>The Company will retain Your Personal Data only for as long as is necessary for the purposes set out in this Privacy Policy. We will retain and use Your Personal Data to the extent necessary to comply with our legal obligation (for example, if we are required to retain your data to comply with applicable laws), resolve disputes, and enforce our legal agreements and policies.</p>
        <p>The Company will also retain Usage Data for internal analysis purposes. Usage Data is generally retained for a shorter period of time, except when this data is used to strengthen the security or to improve the functionality of Our Service, or We are legally obligated to retain this data for longer time periods.</p>

      <h2 className="text-lg font-semibold mt-4 section-title">Transfer of Your Personal Data</h2>
        <p>
      ...
      <h2 className="text-lg font-semibold mt-4 section-title">Delete Your Personal Data </h2>
        <p>
      ...
      <h2 className="text-lg font-semibold mt-4 section-title">Law enforcement</h2>
        <p>
        Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests bypublic authorities (e.g. a court or a government agency).
        </p>

      <h2 className="text-lg font-semibold mt-4 section-title">Other legal requirements</h2>
      ...
      <h2 className="text-lg font-semibold mt-4 section-title">Security of Your Personal Data  </h2>
        <p>
      ...
      <h2 className="text-lg font-semibold mt-4 section-title">Links to Other Websites </h2>
       <p>
